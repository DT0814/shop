...
import cn.xawl.manage.controller.bean.PicUploadResult;
import cn.xawl.manage.service.PropertieService;
...
public class PicUploadController {
    ...
    public String upload(@RequestParam("uploadFile") MultipartFile uploadFile, HttpServletResponse response) throws Exception {
        ...
        // 生成图片的绝对引用地址
        String picUrl = StringUtils.replace(StringUtils.substringAfter(filePath, propertieService.REPORSITORY_PATH), "\\", "/");
    ...
    private String getFilePath(String sourceFileName) {
        String baseFolder = propertieService.REPORSITORY_PATH + File.separator + "images";
